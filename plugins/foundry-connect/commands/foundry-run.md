...
names (or asks you to pick), update its inputs/processOptions, and initiate it. Confirm each write
with a one-line summary before calling. Report the new run id and runUUID when it launches.
