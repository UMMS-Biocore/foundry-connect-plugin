...
3. Confirm. Desktop opens a browser window for OAuth sign-in to Foundry Connect. Click **Approve**,
   and Desktop provisions the token automatically, same as claude.ai. No key to copy or paste.
